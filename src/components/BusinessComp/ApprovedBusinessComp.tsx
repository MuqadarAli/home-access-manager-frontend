...
import { useGetApprovedBusinessesForCommunityQuery } from '../../redux/rtk-query/business';

const ApprovedBusinessComp: React.FC = () => {
  ...
  const {
    ...
    isError,
    isLoading,
  } = useGetApprovedBusinessesForCommunityQuery(community_id);
...
export default ApprovedBusinessComp;
