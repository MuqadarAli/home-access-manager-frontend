...
import { useGetApprovedVehiclesForCommunityQuery } from '../../redux/rtk-query/vehicle';

const ApprovedVehiclesComp: React.FC = () => {
  ...
  const {
    ...
    isError,
    isLoading,
  } = useGetApprovedVehiclesForCommunityQuery(community_id);
  ...
  return (
    <>
      <Breadcrumb pageName="Approved Vehicles" />
...
export default ApprovedVehiclesComp;
